...
from element import ELEMENT, TouchSensorUniversalHingeJointElement, TouchAndLightSensorYAxisHingeJointElement

#np.random.seed(0)
controller = np.random.random((2, 2))

element = TouchAndLightSensorYAxisHingeJointElement(controller)
